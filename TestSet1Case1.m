...
%Random Test
fprintf("\nRANDOM TEST\n")
Cache.run('r', 003, 02, 02, 10009);
Cache.run('r', 001, 01, 02, 10011);
Cache.run('r', 008, 02, 02, 11000);
Cache.run('r', 005, 02, 02, 11003);
Cache.run('r', 004, 01, 02, 11005);
Cache.run('r', 006, 02, 02, 12000);
