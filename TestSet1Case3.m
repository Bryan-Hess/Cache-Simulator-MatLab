...
fprintf("\nWrite Miss in L1 but Hit in L2\n")
Cache.run('w', 007, 01, 02, 10100);
Cache.run('r', 004, 02, 02, 10103);
Cache.run('w', 007, 02, 02, 11000);
Cache.run('r', 001, 01, 02, 11003);
Cache.run('w', 007, 02, 02, 11005);
Cache.run('r', 005, 02, 02, 12003);
Cache.run('w', 002, 01, 02, 12005);
Cache.run('r', 007, 02, 02, 12007);
